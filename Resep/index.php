...
<html>
    ...
    <body>
        ...
        <section class="top">
            <div class="top-bg" style="background-image: url(../images/food.jpg)">
                <div class="bg-bg">
                    <h1 class="main-h1">Resep Makanan</h1>
        ...
        <div class="container">
            ...
            <section class="menu">
                <?php
                $sql = 'SELECT * FROM tb_resep WHERE jenis="makan" ORDER BY id_resep DESC';
                ...
                <div class="menu-list">
                    ...
                    $sql = 'SELECT * FROM tb_resep WHERE jenis="makan" ORDER BY id_resep DESC LIMIT '.$loop.', '.$total_item.'';
                    $result = mysqli_query($connect, $sql);
                    if($result) {
