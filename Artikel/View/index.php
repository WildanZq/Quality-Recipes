...
<html>
    <head>
        ...
        if(isset($_GET['art']) && !empty($_GET['art'])) {
            $sql = 'SELECT * FROM tb_artikel WHERE id_artikel='.$_GET['art'];
    ...
    <body>
        ...
        <section class="top">
            <div class="top-bg" style="background-image: url(../../upload/artikel/<?php echo $foto_art; ?>)">
                <div class="bg-bg">
                    <h1 class="main-h1"><?php echo $judul;?></h1>
                    <p class="main-p">Artikel &amp; Tips</p>
                </div>
            </div>
        </section>
        <div class="container">
            <section class="desc" id="desc" style="">
                <div class="desc-cont">
                    ...
                    <hr class="auth-hr">
                    <p class="desc-p art-text">
                        <?php echo "&emsp;".str_replace("<br />","<br><br>&emsp;",nl2br($konten)); ?>
                    </p>
                </div>
            </section>
        </div>
