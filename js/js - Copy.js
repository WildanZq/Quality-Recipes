...
$(document).ready(function(){
    ...
    $(window).scroll(function() {
        ...
        } else if($(document).scrollTop() >= recipes && $(document).scrollTop() <= forum) {
            $('#nav-recipes').addClass('nav-focus');
            $('#nav-article, #nav-forum').removeClass('nav-focus');
        } else if($(document).scrollTop() >= forum) {
            $('#nav-forum').addClass('nav-focus');
            $('#nav-recipes, #nav-article').removeClass('nav-focus');
        } else {
